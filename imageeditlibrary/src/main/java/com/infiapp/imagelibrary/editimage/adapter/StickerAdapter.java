package com.infiapp.imagelibrary.editimage.adapter;
...
public class StickerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        LinearLayout.LayoutParams paramsBtn = new LinearLayout.LayoutParams(
                mStickerFragment.getActivity().getResources().getDisplayMetrics().widthPixels * 164 / 1080,
                mStickerFragment.getActivity().getResources().getDisplayMetrics().heightPixels * 164 / 1920);
