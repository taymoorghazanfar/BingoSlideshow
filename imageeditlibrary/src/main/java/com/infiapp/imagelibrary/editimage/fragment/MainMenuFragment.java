...
public class MainMenuFragment extends BaseEditFragment implements View.OnClickListener {
    ...
    void setLay() {
        LinearLayout.LayoutParams paramsBtn = new LinearLayout.LayoutParams(
                getActivity().getResources().getDisplayMetrics().widthPixels * 155 / 1080,
                getActivity().getResources().getDisplayMetrics().heightPixels * 155 / 1920);
        paramsBtn.setMargins(0,0,20,0);
