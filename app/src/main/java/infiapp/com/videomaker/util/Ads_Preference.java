...
public class Ads_Preference {
    ...
    String ADMOB_APP_ID = "ca-app-pub-6074653133300509~9284751439";
    String ADMOB_ADS_CLICK_COUNT = "ads_click_counrter";
    String ADMOB_INTERSTITIAL_ID = "ca-app-pub-6074653133300509/1604775805";
    String ADMOB_NATIVE_ADVANCED_ID = "ADMOB_NATIVE_ADVANCED_ID";
    String ADMOB_BANNER_ID = "ca-app-pub-6074653133300509/5098094416";
